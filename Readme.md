...
При слиянии веток, возможен конфликт. В файле появились новые странные дополнения:
...
Самый простой способ разрешить конфликт: просто удалим все разделители конфликта. И выбрать ту версию информации, которая подходит больше.
...
Удалить ветку можно параметром branch с добавлением -d и указанием имени ветки. Если вы завершили работу над веткой и объединили её с основной, можно её удалить без потери истории. Однако, если выполнить команду удаления до слияния — в результате появится сообщение об ошибке. Этот защитный механизм предотвращает потерю доступа к файлам.
