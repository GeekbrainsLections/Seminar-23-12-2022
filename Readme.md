...
### Слияние веток
Для слияния веток используетя команда "git merge". Для этого необходимо встать на ветку в которую будет происходить вливание. Далее в папке-репозитории нужно написать *git merge <название вески которую хотим влить>*
