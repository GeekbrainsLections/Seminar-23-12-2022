...
**git merge {{название ветки}}** - слить указанную ветку в ту ветку, в которой находишься в данный момент

## Удаление веток
**git branch -D {{название ветки}}** - удаление ветки даже если в ней есть незакомиченные изменения или она никуда так и не была влита

**git branch -d {{название ветки}}** - удаление ветки с проверкой, влита ли она куда-то